...
defmodule Mix.Tasks.Coh.InstallTest do
  ...
  test "coh_generates files for authenticatable recoverable unlockable_with_token" do
    in_tmp(
      "coh_generates_files_for_authenticatable_recoverable_registerable_unlockable_with_token",
      fn ->
        mk_web_path()
  ...
  describe "coh_installed options" do
    ...
    test "coh_install options many" do
      ...
      assert output ==
               "mix coh.install --confirmable --rememberable --registerable --invitable --authenticatable --recoverable --lockable --trackable --unlockable-with-token"
    end
  end
